...
# Project root = parent of this file's package root (core/)
# __file__ = .../chatterbox_manga_studio/core/paths.py
# parents[0] = core/, parents[1] = chatterbox_manga_studio/
PROJECT_ROOT = Path(__file__).resolve().parents[1]

PKG_ROOT = PROJECT_ROOT / "src"
...
def edition_dir(project_id: str, target: str) -> Path:
    """Get the edition directory for a project and target language."""
