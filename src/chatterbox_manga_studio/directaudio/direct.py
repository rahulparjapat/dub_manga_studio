...
def adapt_direct_text(
    text: str,
    target: str,
    style: str = "Engaging YouTube Hinglish",
    provider: str = "gemini",
    model: str = "",
) -> dict:
    ...
    from ..adapt import prompts as P
    from ..adapt import providers as PROV
